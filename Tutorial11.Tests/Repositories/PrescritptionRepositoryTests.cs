...
public class PrescritptionRepositoryTests
{
    [Fact]
    public async Task CreateNewAsync_AddsPrescriptionAndReturnsGeneratedId()
    {
        ...
        context.Doctors.Add(new Doctor { IdDoctor = 1, FirstName = "Doc", LastName = "Tor", Email = "doc@tor.com" });
        context.Patients.Add(new Patient { IdPatient = 1, FirstName = "Pat", LastName = "Ent", BirthDate = DateTime.Today });
    ...
    public async Task AddManyMedicamentsToPrescriptionAsync_AddsRowsToDatabase()
    {
        ...
        {
            new() { IdPrescription = 1, IdMedicament = 1, Dose = 10, Details = "Morning" },
            new() { IdPrescription = 1, IdMedicament = 2, Dose = 5, Details = "Evening" }
        };
    ...
    public async Task GetAllByPatientIdAsync_ReturnsPrescriptionsWithRelatedData()
    {
        ...
        context.Doctors.Add(new Doctor { IdDoctor = 1, FirstName = "Michal", LastName = "Pazio", Email = "mpazio@pjwstk.edu.pl" });

        context.Medicaments.Add(new Medicament { IdMedicament = 1, Name = "Aspirin", Description = "Painkiller", Type = "Tablet" });
